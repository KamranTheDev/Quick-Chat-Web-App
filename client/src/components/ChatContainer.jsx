...
const ChatContainer = () => {
  ...
  useEffect(() => {
    const messagesContainer = scrollEnd.current;
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      {/* {chat messages} */}
      <div ref={scrollEnd} className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
          <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
            ...
            onKeyDown={(e)=>e.key ==="Enter" ? handleSendMessage(e) : null} type="text" placeholder="send a message"
              className="flex-1 p-3 border-none rounded-lg py-2
               text-sm outline-none text-white placeholder-gray-400" />
