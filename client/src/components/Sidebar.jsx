      ...
      <div className="pb-5">
        <div className="flex justify-between items-center">
          ...
          <div className="relative py-2 group">
            ...
            />
            <div
              className="absolute right-0 top-full z-20 w-32 p-5 rounded-medium bg-[#282142] border border-gray-600
      ...
      <div className="flex flex-col">
        {
          userDummyData.map((user, index) => (
            ...
            key={index} className={`relative flex items-center gap-2 py-2 pl-4 rounded cursor-pointer
              max-sm:text-sm ${selectedUser?._id === user.id && "bg-[#282142/50]"}`}> 
              ...
              rounded-full bg-violet-500/50">{index}
                </p>}
            </div>
